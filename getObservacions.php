...
$query='SELECT alumne, observacio FROM observacions WHERE tipus_avaluacio="'.$tipus_avaluacio.'" and curs_escolar='.$any_actual.' and nivell="'.$nivell.'" and area="'.$area.'" order by alumne;';
