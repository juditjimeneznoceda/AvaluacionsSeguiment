...
<?php
  	...
  	$sql='SELECT * FROM usuaris WHERE nom_usuari="'.$usuari.'"';
    ...
    if ($row==null){
        $missatge_error="<p>Error</p>";
    } else {
    	if($row['password']==$_POST['password']){
    		$sql='INSERT INTO connexio (id, usuari, data) VALUES (NULL, "'.$usuari.'", CURRENT_TIMESTAMP);';
			$myquery = $mysqli->query($sql);
            ...
            echo $usuari;
            if ($usuari!='notes'){
            	echo "<script>location.href='http://iessineu.net/avaluacio/index.php';</script>";
            	die();
            } else {
            	echo "<script>location.href='http://iessineu.net/avaluacio/bulleti.php';</script>";
            	die();
            }
        } else {
            $missatge_error="<p>Error</p>";
    ...
    if(!$_POST["username"]) $missatge_error="";
...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="login.php" method="post">
		...
		<div class="footer">
		<input type="submit" name="submit" value="Entra" class="button" />
		</div>
